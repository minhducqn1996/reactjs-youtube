                ...
                <section className="download bg-primary text-center" id="download">
                    ...
                    <div className="row">
                        ...
                        <div className="badges">
                            <a className="badge-link" href="/"><img src="img/google-play-badge.svg" alt="App for iphone" /></a>
                            <a className="badge-link" href="/"><img src="img/app-store-badge.svg" alt="App for iphone" /></a>
                        </div>
                        </div>
                    </div>
                    </div>
